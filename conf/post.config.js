...
module.exports = {
  ...
  POST_SCHEDULE_PUBLISH:
    process.env.NEXT_PUBLIC_NOTION_SCHEDULE_PUBLISH || false, // Auto publish/unpublish based on the article's publish time field
  ...
  POSTS_SHARE_SERVICES:
    ...
    'facebook, twitter, telegram, messenger, line', // Services to share, displayed in order, separated by commas
  ...
  // Tag related
  TAG_SORT_BY_COUNT: false, // Whether tags are sorted descending by article count (tags with more articles appear first)
